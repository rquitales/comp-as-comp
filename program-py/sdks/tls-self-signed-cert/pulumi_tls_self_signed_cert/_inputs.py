...
__all__ = [
    'Input_subject_SelfSignedCertSubjectArgs',
    'Input_subject_SelfSignedCertSubjectArgsDict',
]

MYPY = False

if not MYPY:
    class Input_subject_SelfSignedCertSubjectArgsDict(TypedDict):
    ...
    Input_subject_SelfSignedCertSubjectArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class Input_subject_SelfSignedCertSubjectArgs:
