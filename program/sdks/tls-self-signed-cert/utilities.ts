...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("tls-self-signed-cert");
			params.setVersion("0.1.3");
			params.setValue(Uint8Array.from(atob("L1VzZXJzL21pa2hhaWxzaGlsa292L2dvL3NyYy9naXRodWIuY29tL3B1bHVtaS9wbGF5L2NvbXAtYXMtY29tcC9wdWx1bWktdGxzLXNlbGYtc2lnbmVkLWNlcnQ="), c => c.charCodeAt(0)));

			const req = new resproto.RegisterPackageRequest();
			req.setName("component");
			req.setVersion("0.1.3");
			req.setDownloadUrl("");
